...
class Client():
    ...
    def performAdminAction(self, admin, selection):
        ...
        elif selection == 4: admin._applicationPrivileges.createApplication()
        elif selection == 5: admin._applicationPrivileges.viewPendingApplications()
        elif selection == 6: admin._applicationPrivileges.declineApplication()
        elif selection == 7: admin._applicationPrivileges.approveApplication()
        elif selection == 8: admin._applicationPrivileges.viewScholarships()
        elif selection == 9: admin._applicationPrivileges.removeScholarship()